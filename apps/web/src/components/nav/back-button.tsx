...
export function BackButton({
  ...
  return (
    <button
      ...
      className="sk-press inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(var(--brand-primary))]"
      style={{
        background: light
          ? "rgb(var(--bg-elevated))"
          : "rgb(var(--bg-elevated))",
