...
import { SecondaryCta } from "~/components/artist/funnel/funnel-ui";
...
export function MySessionsScreen({
  ...
  return (
    <div className="space-y-4">
      {/* (1) eyebrow row */}
      <div className="reveal-up inline-flex items-center gap-[9px] font-mono text-[10px] font-bold uppercase tracking-[0.16em] text-[rgb(var(--fg-muted))]">
        <span
          aria-hidden
          className="h-[6px] w-[6px] rounded-full"
          style={{ background: "rgb(var(--brand-primary))" }}
        />
        <span className="font-syne text-[13px] font-extrabold normal-case tracking-[-0.01em] text-[rgb(var(--fg-default))]">
          My sessions.
        </span>
      </div>
      ...
      {sessions.length === 0 ? (
        ...
        <div
          className="reveal-up rounded-[var(--radius-lg)] px-4"
          style={{
