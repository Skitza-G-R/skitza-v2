...
export function PdfCanvasInner({
  pdfUrl,
  fields,
  selectedIndex,
  onSelect,
...
// `useRemountKey` now lives in the wrapper (pdf-canvas.tsx) so
// consumers can import it without pulling react-pdf into their chunk.
