// Inline brand SVG icons for the Done screen's share strip. Lucide
// dropped Instagram + Twitter brand icons in v1.x; rather than pull a
// separate brand-icons dependency, we ship just the four glyphs the
// share strip needs. Each icon is path-only so it picks up
// currentColor + sizes via width/height.
...
export function XTwitterIcon({ size = 16 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
