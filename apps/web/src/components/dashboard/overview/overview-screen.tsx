...
function UrgencyPill({
  ...
  if (urgency === "overdue") {
    return (
      <span className="inline-flex items-center rounded-[var(--radius-sm)] border border-[rgb(var(--fg-danger)/0.25)] bg-[rgb(var(--fg-danger)/0.08)] px-2 py-0.5 font-mono text-[9.5px] font-bold uppercase tracking-widest text-[rgb(var(--fg-danger))]">
        Overdue
      </span>
    );
  }
  if (urgency === "deposit_due") {
    return (
      <span className="inline-flex items-center rounded-[var(--radius-sm)] border border-[rgb(var(--fg-warning)/0.3)] bg-[rgb(var(--fg-warning)/0.10)] px-2 py-0.5 font-mono text-[9.5px] font-bold uppercase tracking-widest text-[rgb(var(--fg-warning))]">
        Deposit due
      </span>
    );
  }
  return (
    <span className="inline-flex items-center rounded-[var(--radius-sm)] border border-[rgb(var(--border-strong))] bg-[rgb(var(--bg-overlay))] px-2 py-0.5 font-mono text-[9.5px] font-bold uppercase tracking-widest text-[rgb(var(--fg-muted))]">
      Stuck
    </span>
  );
}
        ...
        <div className="relative min-w-[200px] flex-1 border-r border-[rgb(var(--border-subtle)/0.7)] px-4 py-3 sm:px-5">
          ...
          <div className="mt-2 flex items-baseline gap-2.5">
            ...
            {pulseStats.deltaPct !== null && pulseStats.deltaPct !== 0 ? (
              <span
                className={[
                  "inline-flex items-center gap-0.5 rounded-[var(--radius-sm)] border px-1.5 py-0.5 font-mono text-[10px] font-bold tabular-nums",
