...
export function NeedsYouPaymentRow({ payment }: { payment: PaymentSource }) {
  ...
  const amount = cents > 0 ? formatMoney(cents, "ILS") : null;
  ...
  return (
    <li className="border-b border-[rgb(var(--fg-onsidebar)/0.16)] last:border-b-0 lg:border-[rgb(var(--border-subtle))]">
      <div className="flex min-h-[72px] min-w-0 items-center gap-3 py-3 lg:min-h-[68px] lg:py-2.5">
        ...
        <Link
          href={href}
          className="sk-press inline-flex h-11 shrink-0 items-center justify-center rounded-[var(--radius-lg)] border border-[rgb(var(--fg-onsidebar)/0.34)] px-3 text-sm font-semibold text-[rgb(var(--fg-onsidebar))] lg:h-10 lg:rounded-[var(--radius-md)] lg:border-[rgb(var(--border-strong))] lg:text-[rgb(var(--fg-default))]"
        >
        ...
        <button
          ...
          className="sk-press flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-[rgb(var(--fg-onsidebar)/0.6)] hover:bg-[rgb(var(--fg-onsidebar)/0.08)] disabled:opacity-50 lg:text-[rgb(var(--fg-muted))] lg:hover:bg-[rgb(var(--bg-overlay))]"
        >
      ...
      {error ? (
        <p
          role="alert"
          className="mb-2 rounded-[var(--radius-sm)] bg-[rgb(var(--fg-danger)/0.1)] px-3 py-2 text-xs text-[rgb(var(--fg-danger))]"
        >
          {error}
        </p>
      ) : null}
