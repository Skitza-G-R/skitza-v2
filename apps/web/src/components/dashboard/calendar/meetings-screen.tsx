            ...
            <div className="mt-1 flex gap-2">
              <SheetClose asChild>
                <button
                  ...
                  className="sk-press flex-1 rounded-[var(--radius-lg)] border border-[rgb(var(--border-subtle))] bg-transparent px-4 py-3 text-sm font-semibold text-[rgb(var(--fg-default))]"
                >
                  Decline
                </button>
              </SheetClose>
              <button
                ...
                className="sk-press flex flex-[2] items-center justify-center gap-1.5 rounded-[var(--radius-lg)] bg-[rgb(var(--brand-primary))] px-4 py-3 text-sm font-bold text-[rgb(var(--bg-sidebar))]"
              >
