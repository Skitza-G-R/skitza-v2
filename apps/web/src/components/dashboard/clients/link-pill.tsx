...
export function LinkPill({ state, onInvite }: LinkPillProps) {
  if (state === "active") {
    return (
      <span
        className="inline-flex items-center gap-1.5 rounded-[var(--radius-lg)] border px-2.5 py-0.5 text-[11px] font-medium uppercase tracking-wide"
        style={{
