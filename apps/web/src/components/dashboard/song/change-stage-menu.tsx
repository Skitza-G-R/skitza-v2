  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        aria-expanded={open}
        disabled={pending}
        className="sk-press inline-flex items-center gap-1.5 rounded-[var(--radius-lg)] border px-2.5 py-1 text-[11px] font-bold uppercase tracking-widest disabled:opacity-60"
        style={{
          color: hue,
          borderColor: hue,
