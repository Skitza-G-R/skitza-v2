...
//
// SK-25 final pass: stripped to just the Skitza wordmark on the left.
// The slug pill, anchor links, and "Book a session" CTA were removed
// because they were noise on a single-screen public page — the visitor
// isn't in the app yet, has no surfaces to navigate to from here, and
// the bento's own primary CTA is always visible. The wordmark is the
// only piece of brand chrome that earns its place: it both anchors
// identity and gives the visitor a way back to skitza.app.
