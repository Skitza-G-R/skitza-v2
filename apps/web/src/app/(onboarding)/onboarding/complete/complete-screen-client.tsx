  ...
  return (
    ...
    >
      ...
      <div className="ob-stagger flex flex-col items-center text-center">
        ...
        <span className="mb-7 inline-flex items-center gap-2 rounded-[var(--radius-lg)] bg-[rgb(var(--brand-primary)/0.12)] px-3 py-1.5 font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-[rgb(var(--brand-primary-dark))]">
          <span
            aria-hidden
