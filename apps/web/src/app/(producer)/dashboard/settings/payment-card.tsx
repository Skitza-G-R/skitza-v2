...
function StatusBadge({
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full border border-[rgb(var(--border-subtle))] bg-[rgb(var(--bg-base))] px-2.5 py-1 text-xs font-medium text-[rgb(var(--fg-muted))]">
      Not connected
    </span>
  );
}
