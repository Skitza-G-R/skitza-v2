...
export function SegmentedTabs<V extends string>({
  ...
  return (
    <div role="group" aria-label={ariaLabel} className="inline-flex gap-1 rounded-[var(--radius-sm)] border border-[rgb(var(--border-subtle))] bg-[rgb(var(--bg-elevated))] p-1">
      {items.map((it) => {
          ...
          >
            ...
            {it.count > 0 ? (
              <span
                aria-hidden
                className={[
                  "inline-flex min-w-[18px] items-center justify-center rounded-[var(--radius-sm)] px-1 text-[10.5px] font-bold tabular-nums",
                  active
