            ...
            <div className="border-b border-[rgb(var(--border-subtle))] px-6 pb-[18px] pt-[20px]">
              <div className="flex items-center gap-3">
                <DialogPrimitive.Close
                  aria-label="Close"
                  className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-[rgb(var(--fg-muted))] transition-colors hover:bg-[rgb(17_16_9/0.06)] hover:text-[rgb(var(--fg-default))]"
                >
              ...
              <div>
                {isFirstStep ? null : (
                  <button
                    type="button"
                    onClick={onBack}
                    className="inline-flex h-9 items-center rounded-full px-3 text-[13px] font-medium text-[rgb(var(--fg-muted))] transition-colors hover:bg-[rgb(17_16_9/0.06)] hover:text-[rgb(var(--fg-default))]"
                  >
                    ← Back
                  </button>
                )}
              ...
              <div className="flex items-center gap-2">
                {isLastStep ? (
                  ...
                  <button
                    ...
                    className="inline-flex h-9 items-center rounded-full bg-[rgb(var(--fg-default))] px-4 text-[13px] font-semibold text-[rgb(var(--bg-elevated))] shadow-sm transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    Continue →
                  </button>
                )}
