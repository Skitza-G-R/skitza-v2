          ...
          {includes.length === 0 ? (
            ...
            includes.map((s) => (
              <button
                ...
                aria-label={`Remove ${s}`}
                className="group inline-flex h-[30px] items-center gap-2 rounded-[var(--radius-md)] border border-[rgb(var(--border-subtle))] bg-white pl-3 pr-1.5 text-[12.5px] font-semibold text-[rgb(var(--fg-default))] shadow-[0_1px_2px_rgba(17,16,9,0.04)] transition-colors hover:border-[rgb(var(--danger,220_56_56))] hover:bg-red-50"
              >
                <span>{s}</span>
                <span
                  aria-hidden
          ...
          <div className="flex flex-wrap gap-2">
            {available.map((ex) => (
              <button
                ...
                className="inline-flex h-[30px] items-center gap-2 rounded-[var(--radius-md)] border border-[rgb(var(--border-subtle))] bg-[rgb(var(--bg-elevated))] pl-2 pr-3.5 text-[12.5px] font-semibold text-[rgb(var(--fg-default))] transition-colors hover:border-[rgb(var(--brand-primary))] hover:bg-[rgb(var(--brand-primary)/0.08)]"
              >
                <span
                  aria-hidden
      ...
      <div>
        ...
        >
          ...
          <button
            ...
            className="inline-flex h-10 items-center gap-1.5 rounded-[var(--radius-md)] bg-[rgb(var(--brand-primary))] px-4 text-[12.5px] font-semibold text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
          >
