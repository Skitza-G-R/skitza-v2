...
export const alt = "Skitza — one app. Your whole studio. Business automation for music producers.";
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 30 }}>
        ...
        >
          <div style={{ display: "flex", whiteSpace: "nowrap" }}>One app</div>
          <div style={{ display: "flex", whiteSpace: "nowrap" }}>Your whole studio</div>
        </div>
        ...
        >
          Clients, projects, audio review, bookings, agreements and external-payment records — one
          place for solo music producers.
        </div>
      </div>
