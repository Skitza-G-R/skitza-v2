...
//
// PlayerProvider is mounted at the layout level (not per-page) so the
// FloatingPlayer survives navigation between pages — playing a track
// on /dashboard/music keeps playing when you nav to /dashboard/projects.
//
