// Loading state for S7 (choose plan) — warm skeleton (not a spinner), per
// design system §7. Full-screen funnel overlay mirroring the screen
// silhouette: top-bar ghost → heading line → plan option cards → pinned
// CTA ghost.
    ...
    >
      <div className="mx-auto w-full max-w-[440px]">
        ...
        <div className="px-5 pt-3.5">
          ...
          {/* plan option cards */}
          <Block className="mt-4 h-[92px] w-full rounded-[var(--radius-lg)]" />
          <Block className="mt-3 h-[92px] w-full rounded-[var(--radius-lg)]" />
          <Block className="mt-3 h-[92px] w-full rounded-[var(--radius-lg)]" />
        </div>
      </div>
