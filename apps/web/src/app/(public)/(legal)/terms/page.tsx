    ...
    <div className="py-16 md:py-24">
      ...
      <div className="mt-12 space-y-10 text-[rgb(var(--fg-secondary))]">
        <Section title="Agreeing to these terms">
          <p>
            These Terms apply when you access or use Skitza. By using the service, you agree to
            these Terms and the Privacy Notice. If you use Skitza for a business or another
            person, you confirm that you have authority to act for them. You may use Skitza only
            if you can legally agree to these Terms and have any parent or guardian consent your
            local law requires.
          </p>
        </Section>
        ...
        <Section title="What Skitza provides">
          <p>
            ...
            clients, projects, products, offers, bookings, accepted terms, external-payment
            records, music versions, feedback, approvals, and controlled delivery. Artists use a
            Producer&apos;s Skitza link to join that studio and work with the Producer.
          </p>
          <p className="mt-3">
            Producer access is invitation-only. Artist access begins through a valid Producer
            join flow. One person may have both roles on the same account, but an invitation,
            account, or access right may not be sold, transferred, or shared with another person.
          </p>
        </Section>
        ...
        <Section title="Your account">
          <List>
            ...
            <li>Protect your sign-in method and tell us promptly if your account is compromised.</li>
            <li>
              You are responsible for actions taken through your account unless those actions
              result from Skitza&apos;s own security failure.
            </li>
            <li>
        ...
        <Section title="Your content and permissions">
          <p>
            ...
            content you submit. You give Skitza a limited, non-exclusive permission to host,
            copy, process, display, transmit, and deliver that content only as needed to operate,
            secure, and support the service and the sharing choices you make.
          </p>
          <p className="mt-3">
        ...
        <Section title="Agreements and external payments">
          <p>
            Producers set their services, prices, rights, royalty terms, payment plans, and
            external payment instructions. Artists can review and accept the exact terms shown to
            them. Skitza stores accepted terms and related history as a durable record, so users
            must review them carefully before accepting.
          </p>
          <p className="mt-3">
        ...
        <Section title="Google Calendar">
          <p>
            ...
            Producer grants to list calendars, check selected calendars for busy time, and
            create, update, cancel, watch, and reconcile Skitza-linked session events. The
            Producer can disconnect from the Calendar control. Existing Google events remain
            after disconnect unless they are removed in Google Calendar.
          </p>
          <p className="mt-3">
        ...
        <Section title="Acceptable use">
          ...
          <List>
            ...
            <li>Probe, bypass, overload, scrape, reverse engineer, or disrupt security controls.</li>
        ...
        <Section title="Beta access and service changes">
          <p>
            Skitza is currently in beta and Producer access is free during the beta. The current
            Producer audio-storage limit is 1 GB. We do not currently collect payment-card details
            for use of the Skitza platform. If a paid platform plan is introduced later, we will
            present its price and terms before charging anyone.
          </p>
          <p className="mt-3">
        ...
        <Section title="Availability and third-party services">
          <p>
            We work to keep Skitza available and records accurate, but beta software and
            third-party services can fail or be interrupted. Skitza is provided on an
            “as available” basis to the extent permitted by law. Keep copies of files and records
            that are critical to your business. We do not guarantee uninterrupted access,
            delivery, Calendar sync, email delivery, or a particular business result.
          </p>
          <p className="mt-3">
            Nothing in these Terms limits a right or remedy that applicable law does not allow us
            to limit.
          </p>
        </Section>
        ...
        <Section title="Suspension, closure, and retained records">
          ...
          <p className="mt-3">
            Account closure does not automatically erase every shared or historical record.
            Accepted agreements, purchases, payment records and proofs, sessions, approvals,
            security records, and related history may be retained as described in the Privacy
            Notice. Provisions that by their nature need to continue after closure remain in
            effect, including content permissions needed for retained records and rules about
        ...
        <Section title="Changes and contact">
          <p>
            ...
            additional notice when a material change requires it. Changes apply going forward and
            do not silently rewrite already accepted Producer–Artist commercial terms.
          </p>
          <p className="mt-3">
            For a contractual or Terms question, email <MailLink address="legal@skitza.app" />.
            For a privacy request, email <MailLink address="privacy@skitza.app" />.
          </p>
        </Section>
      </div>
    </div>
